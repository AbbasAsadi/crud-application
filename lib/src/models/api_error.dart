...
class ApiError extends DioException {
  ...
  ApiError(this.code, this.errorMessage, {required super.requestOptions, required this.errorType});
  ...
  @override
  String toString() {
    return 'ApiError [${errorType.toPrettyDescription()}]: $errorMessage with code: $code';
  }
}
